 ...
 <footer class="footer-one footer-one--two">
    <div class="footer-one__pattern">
        <img src="{{asset('assets/images/pattern/footer-v1-pattern.png')}}" alt="#">
    </div>
    <div class="shape3 float-bob-y">
        <img src="{{asset('assets/images/shapes/footer-v2-shape3.png')}}" alt="">
    </div>
    <div class="footer-one__top">
        <div class="container">
            ...
            <div class="footer-one--two__cta">
                <div class="shape1">
                    <img class="float-bob-x3" src="{{asset('assets/images/shapes/footer-v2-shape2.png')}}" alt="">
                </div>
                <div class="shape2">
                    <img class="float-bob-y" src="{{asset('assets/images/shapes/footer-v2-shape1.png')}}" alt="">
                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="footer-widget__single footer-one__about">
                            <div class="footer-one__about-logo">
                                <a href="{{route('home')}}"><img src="{{asset('assets/images/logo/dx png (1).png')}}"
                                        alt=""></a>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="footer-widget__single footer-one__quick-links">
                            ...
                            <ul class="footer-one__quick-links-list">
                                ...
                                <li><a href="project.html"><span class="icon-right-arrow1"></span>Blog</a></li>
                            ...
                            <div class="footer-one__contact-box">
                                <ul>
                                    <li>
                                        ...
                                        <div class="text-box">
                                            <p>Al  Kazim Building,<br>
                                            Horl Al Anz East<br>
                                        Office - 201,Dubai - UAE</p>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="text-box">
                                            <p><a href="info@dxiexpresscargo.com">info@dxiexpresscargo.com</a></p>
                                    ...
                                    <li>
                                        ...
                                        <div class="text-box">
                                            <p><a href="tel:+971 56565 6539">+971 56565 6539 </a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="container">
            ...
            <div class="footer-one__bottom-inner">
                <div class="footer-one__bottom-text">
                    <p>© Copyright 2024 <a href="index.html">Logistiq.</a> All Rights Reserved</p>
                </div>
