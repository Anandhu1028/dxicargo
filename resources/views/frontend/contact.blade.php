...
<section class="contact-page">
    ...
    <div class="contact-page__top">
        <div class="contact-page__top-pattern"
            style="background-image: url({{asset('assets/images/pattern/contact-page-top-pattern.png')}});"></div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="contact-page__top-form">
                        <form class="contact-form-validated why-choose-one__form"
                            action="https://unicktheme.com/demo/logistiq/main-html/assets/inc/sendemail.php" method="post" novalidate="novalidate">
                            <div class="row">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="contact-page__bottom-single">
                        ...
                        <div class="content">
                            <h2>Email</h2>
                            <p>
                                <a href="mailto:info@dxiexpresscargo.com">info@dxiexpresscargo.com</a> <br>
